...
import { CarOutlined, CarryOutFilled, CarTwoTone, ShopOutlined } from '@ant-design/icons'
    ...
    <div className='flex-grow p-5'>
        ...
        {!isLoading &&
                ...
                {products.map(product => (
                     ...
                     >
                        <div>
                            <img src={product.images[0]} className='w-full h-[30%] sm:h-[100px]'/>
                        </div>
                        ...
                        <Button className='w-full h-[2rem]'>Add to cart <ShopOutlined className='text-red-700'/></Button>
                    </Card> 
                ))}
            </div>
        }
